...
var LegendComponent = class _LegendComponent {
  constructor() {
    this.mode = input("absolute");
    this.absoluteStops = [
      { label: "\u22120\xB0", color: "var(--temp-c0)" },
      { label: "20\xB0", color: "var(--temp-c1)" },
      { label: "40\xB0", color: "var(--temp-c2)" },
      { label: "60\xB0", color: "var(--temp-c3)" },
      { label: "75\xB0", color: "var(--temp-c4)" },
      { label: "90\xB0", color: "var(--temp-c5)" },
      { label: "110\xB0", color: "var(--temp-c6)" }
    ];
    this.deviationStops = [
      { label: "\u221220\xB0", color: "var(--dev-cold)" },
      { label: "\u221210\xB0", color: "var(--dev-cool)" },
      { label: "0\xB0", color: "var(--dev-mid)" },
      { label: "+10\xB0", color: "var(--dev-warm)" },
      { label: "+20\xB0", color: "var(--dev-hot)" }
    ];
...
//# sourceMappingURL=chunk-CLUWDDKR.js.map

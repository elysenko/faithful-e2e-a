...
var AdminJobsComponent = class _AdminJobsComponent {
  constructor() {
    this.jobs = signal([
      {
        id: "job-20260628-ghcn",
        targetDate: "2026-06-28",
        source: "GHCN-Daily",
        status: "running",
        startedAt: "2026-06-28T06:00:04Z",
        finishedAt: null,
        durationMs: null,
        stationsIngested: 18420,
        attempts: 1,
        message: "Streaming GHCN-Daily flat files from NOAA NCEI FTP\u2026"
      },
      {
        id: "job-20260627-ghcn",
        targetDate: "2026-06-27",
        source: "GHCN-Daily",
        status: "success",
        startedAt: "2026-06-27T06:00:03Z",
        finishedAt: "2026-06-27T06:07:41Z",
        durationMs: 458e3,
        stationsIngested: 41233,
        attempts: 1,
        message: null
      },
      {
        id: "job-20260626-ghcn",
        targetDate: "2026-06-26",
        source: "GHCN-Daily",
        status: "retrying",
        startedAt: "2026-06-26T06:00:02Z",
        finishedAt: null,
        durationMs: null,
        stationsIngested: 0,
        attempts: 2,
        message: "FTP connection reset \u2014 retry 2 of 3 (exponential backoff)."
      },
      {
        id: "job-20260625-ghcn",
        targetDate: "2026-06-25",
        source: "GHCN-Daily",
        status: "failed",
        startedAt: "2026-06-25T06:00:02Z",
        finishedAt: "2026-06-25T06:14:55Z",
        durationMs: 893e3,
        stationsIngested: 0,
        attempts: 3,
        message: "NOAA NCEI FTP unreachable after 3 retries \u2014 operator alerted."
      },
      {
        id: "job-20260624-ghcn",
        targetDate: "2026-06-24",
        source: "GHCN-Daily",
        status: "success",
        startedAt: "2026-06-24T06:00:03Z",
        finishedAt: "2026-06-24T06:06:58Z",
        durationMs: 415e3,
        stationsIngested: 40987,
        attempts: 1,
        message: null
      },
      {
        id: "job-normals-baseline",
        targetDate: "2026-06-01",
        source: "Climate Normals 1991-2020",
        status: "success",
        startedAt: "2026-06-01T02:00:00Z",
        finishedAt: "2026-06-01T02:38:12Z",
        durationMs: 2292e3,
        stationsIngested: 9215,
        attempts: 1,
        message: "One-time deviation baseline import complete."
      }
    ]);
...
//# sourceMappingURL=chunk-SMQSPX25.js.map

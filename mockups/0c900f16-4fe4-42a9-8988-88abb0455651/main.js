...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-CLUWDDKR.js").then((m) => m.VisualizationComponent),
    title: "US Temperature Anomaly Visualization"
  },
  {
    path: "admin/login",
    loadComponent: () => import("./chunk-S5TCTNN7.js").then((m) => m.AdminLoginComponent),
    title: "Admin Login"
  },
  {
    // The protected (admin) route group.
    path: "admin",
    canActivate: [adminGuard],
    loadComponent: () => import("./chunk-I6YO2AWW.js").then((m) => m.AdminShellComponent),
    children: [
      { path: "", pathMatch: "full", redirectTo: "jobs" },
      {
        path: "jobs",
        loadComponent: () => import("./chunk-SMQSPX25.js").then((m) => m.AdminJobsComponent),
        title: "Ingestion Jobs"
      },
      {
        path: "settings",
        loadComponent: () => import("./chunk-NPTMPYWO.js").then((m) => m.AdminSettingsComponent),
        title: "Settings"
      }
    ]
  },

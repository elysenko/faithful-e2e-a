...
var AdminSettingsComponent = class _AdminSettingsComponent {
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      try {
        this.members.set(yield this.api.listUsers());
      } catch {
      }
    });
  }
  ...
  /** Role changes are local only — the backend exposes no role-update procedure. */
  setRole(id, role) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminSettingsComponent, { className: "AdminSettingsComponent", filePath: "src/app/admin/admin-settings.component.ts", lineNumber: 21 });
})();
export {
  AdminSettingsComponent
};
//# sourceMappingURL=chunk-RSLEBSMJ.js.map

...
var SignupComponent = class _SignupComponent {
  ...
  submit() {
    ...
    setTimeout(() => {
      this.auth.signup(this.name().trim(), this.email());
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignupComponent, { className: "SignupComponent", filePath: "src/app/auth/signup.component.ts", lineNumber: 14 });
})();
export {
  SignupComponent
};
//# sourceMappingURL=chunk-OBON2AXW.js.map

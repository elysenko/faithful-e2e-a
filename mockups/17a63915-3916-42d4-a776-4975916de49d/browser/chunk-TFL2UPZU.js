...
var ShellComponent = class _ShellComponent {
  constructor() {
    ...
    this.nav = [
      ...
      { label: "Accounts", path: "/accounts", icon: "\u{1F3E2}" },
      { label: "Contacts", path: "/contacts", icon: "\u{1F464}" },
      { label: "Opportunities", path: "/opportunities", icon: "\u{1F4B0}" },
      { label: "Pipeline", path: "/pipeline", icon: "\u{1F4C8}" },
      { label: "Leads", path: "/leads", icon: "\u{1F3AF}" },
      { label: "Tasks", path: "/tasks", icon: "\u2713" },
      { label: "Settings", path: "/admin/settings", icon: "\u2699\uFE0F", admin: true }
    ];
  }
  toggleDrawer() {
...
//# sourceMappingURL=chunk-TFL2UPZU.js.map

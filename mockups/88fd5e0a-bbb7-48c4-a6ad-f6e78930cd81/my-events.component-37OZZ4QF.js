...
var MyEventsComponent = class _MyEventsComponent {
  ...
  static {
    this.\u0275fac = function MyEventsComponent_Factory(t) {
      return new (t || _MyEventsComponent)(\u0275\u0275directiveInject(ApiService));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MyEventsComponent, { className: "MyEventsComponent", filePath: "src/app/pages/my-events/my-events.component.ts", lineNumber: 18 });
})();
export {
  MyEventsComponent
};
//# sourceMappingURL=my-events.component-37OZZ4QF.js.map

...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./login.component-UQ22A3RK.js").then((m) => m.LoginComponent),
    data: { flow: { node: "login", entry: true, edgesTo: ["home", "signup", "organizer"] } }
  },
  {
    path: "signup",
    loadComponent: () => import("./signup.component-5SOQPLKB.js").then((m) => m.SignupComponent),
  ...
  },
  {
    ...
    children: [
      // ---- Public browse ----
      {
        path: "",
        pathMatch: "full",
        loadComponent: () => import("./home.component-3Q4EIQJ3.js").then((m) => m.HomeComponent),
        data: { flow: { node: "home", showInNavbar: true, edgesTo: ["events", "event-detail", "my-events"] } }
      },
      {
        path: "events",
        loadComponent: () => import("./events-list.component-QSAOOY57.js").then((m) => m.EventsListComponent),
        data: { flow: { node: "events", showInNavbar: true, edgesTo: ["event-detail", "home"] } }
      },
      {
        path: "events/:id",
        loadComponent: () => import("./event-detail.component-AAV3H2EN.js").then((m) => m.EventDetailComponent),
      ...
      // ---- Attendee (any logged-in user) ----
      {
        ...
        loadComponent: () => import("./my-events.component-37OZZ4QF.js").then((m) => m.MyEventsComponent),
      ...
      // ---- Organizer ----
      {
        ...
        loadComponent: () => import("./organizer-dashboard.component-Q5N75OIF.js").then((m) => m.OrganizerDashboardComponent),
      ...
      },
      {
        ...
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./organizer-event-attendees.component-W6T2AVD2.js").then((m) => m.OrganizerEventAttendeesComponent),
        data: { roles: ORGANIZER.roles, flow: { node: "organizer-event-attendees", scope: "organizer", edgesTo: ["organizer"] } }
      },
      {
        path: "organizer/venues",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./venues-list.component-WQUTOVGX.js").then((m) => m.VenuesListComponent),
      ...
      },
      {
        ...
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./venue-form.component-YFUSRHIY.js").then((m) => m.VenueFormComponent),

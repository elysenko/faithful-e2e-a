import {
  AuthService
} from "./chunk-NNNJYUHM.js";
import "./chunk-BE3JJKRU.js";
import {
  Router,
  RouterOutlet,
...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./login.component-KGAQSGWV.js").then((m) => m.LoginComponent),
    data: { flow: { flowId: "login", node: "login", entry: true, edgesTo: ["feed"], label: "Login" } }
  },
  {
    path: "",
    loadComponent: () => import("./main-layout.component-LDHYJQFU.js").then((m) => m.MainLayoutComponent),
    canActivate: [authGuard],
    children: [
      {
        path: "feed",
        loadComponent: () => import("./feed.component-AB4XJBNJ.js").then((m) => m.FeedComponent),
        canActivate: [profileCompleteGuard],
        data: { flow: { flowId: "feed", node: "feed", showInNavbar: true, label: "Discover", scope: "all", edgesTo: ["user-profile", "matches"] } }
      },
      {
        path: "matches",
        loadComponent: () => import("./matches.component-ML6LJBDL.js").then((m) => m.MatchesComponent),
        data: { flow: { flowId: "matches", node: "matches", showInNavbar: true, label: "Matches", scope: "all", edgesTo: ["conversation"] } }
      },
      {
        path: "matches/:matchId",
        loadComponent: () => import("./conversation.component-4DHXANDE.js").then((m) => m.ConversationComponent),
        data: { flow: { flowId: "conversation", node: "conversation", label: "Conversation", edgesTo: ["matches", "user-profile"] } }
      },
      {
        path: "users/:userId",
        loadComponent: () => import("./user-profile.component-GSBFVGT2.js").then((m) => m.UserProfileComponent),
        data: { flow: { flowId: "user-profile", node: "user-profile", label: "Member Profile", edgesTo: ["feed", "conversation"] } }
      },
      {
        path: "profile/edit",
        loadComponent: () => import("./profile-edit.component-QE62CNVQ.js").then((m) => m.ProfileEditComponent),
        data: { flow: { flowId: "profile-edit", node: "profile-edit", showInNavbar: true, label: "Profile", scope: "all", edgesTo: ["feed"] } }
      },
      {
        path: "settings",
        loadComponent: () => import("./settings.component-BSENNX6M.js").then((m) => m.SettingsComponent),
        data: { flow: { flowId: "settings", node: "settings", showInNavbar: true, label: "Settings", scope: "all", edgesTo: ["login", "profile-edit"] } }
      },
      {
        path: "admin/moderation",
        loadComponent: () => import("./moderation.component-UBJBZPCC.js").then((m) => m.ModerationComponent),
      ...
      {
        path: "admin/reports",
        loadComponent: () => import("./reports.component-VZXZFRLO.js").then((m) => m.ReportsComponent),
        canActivate: [adminGuard],
        data: { flow: { flowId: "admin-reports", node: "admin-reports", label: "Reports Queue", scope: "admin", edgesTo: ["report-detail"] } }
      },
      {
        path: "admin/reports/:reportId",
        loadComponent: () => import("./report-detail.component-452LWXOV.js").then((m) => m.ReportDetailComponent),
        canActivate: [adminGuard],

...
function LayoutComponent_Conditional_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function LayoutComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(0, LayoutComponent_Conditional_10_Conditional_0_Template, 2, 0, "a", 11);
    ...
    \u0275\u0275listener("click", function LayoutComponent_Conditional_10_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r2);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(0, ctx_r2.auth.isManager() ? 0 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275classProp("manager", ctx_r2.auth.isManager());
    \u0275\u0275advance(2);
...
function LayoutComponent_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 9)(1, "span", 19);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function LayoutComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 22)(1, "span", 19);
    \u0275\u0275text(2, "\u{1F464}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 20);
    \u0275\u0275text(4, "Log in");
...
var LayoutComponent = class _LayoutComponent {
  constructor(auth) {
    this.auth = auth;
    this.allNav = [
      { label: "Items", icon: "\u{1F4E6}", link: "/", scope: "auth", exact: true },
      { label: "Record", icon: "\u{1F501}", link: "/movements/new", scope: "auth" },
      { label: "Low Stock", icon: "\u26A0\uFE0F", link: "/reports/low-stock", scope: "manager" },
      { label: "Movements", icon: "\u{1F9FE}", link: "/movements", scope: "manager", exact: true },
      { label: "Locations", icon: "\u{1F4CD}", link: "/locations", scope: "manager" },
      { label: "Settings", icon: "\u2699\uFE0F", link: "/admin/settings", scope: "manager" }
    ];
    this.nav = computed(() => {
      const manager = this.auth.isManager();
      return this.allNav.filter((n) => n.scope === "manager" ? manager : true);
    });
    this.bottomNav = computed(() => this.nav().slice(0, 5));
    this.userName = computed(() => this.auth.user()?.name || this.auth.user()?.email || "Account");
    this.roleLabel = computed(() => this.auth.isManager() ? "Manager" : "Clerk");
  }
  ngOnInit() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LayoutComponent, selectors: [["app-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 19, vars: 2, consts: [[1, "app-header", "no-print"], ["routerLink", "/", 1, "brand"], [1, "brand-mark"], [1, "brand-name"], [1, "top-nav"], ["routerLinkActive", "active", 1, "top-nav-link", 3, "routerLink", "routerLinkActiveOptions"], [1, "header-right"], [1, "app-main"], ["aria-label", "Primary", 1, "bottom-nav", "no-print"], ["routerLinkActive", "active", 1, "bottom-nav-item", 3, "routerLink", "routerLinkActiveOptions"], ["type", "button", 1, "bottom-nav-item"], ["routerLink", "/admin/settings", "aria-label", "Settings", 1, "icon-btn", "settings-mobile"], [1, "user-chip"], [1, "role-dot"], [1, "user-name"], [1, "role-tag"], ["type", "button", 1, "btn", "btn-outline", "btn-sm", 3, "click"], ["routerLink", "/login", 1, "btn", "btn-outline", "btn-sm"], ["routerLink", "/signup", 1, "btn", "btn-primary", "btn-sm"], ["aria-hidden", "true", 1, "bn-icon"], [1, "bn-label"], ["type", "button", 1, "bottom-nav-item", 3, "click"], ["routerLink", "/login", "routerLinkActive", "active", 1, "bottom-nav-item"]], template: function LayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(10, LayoutComponent_Conditional_10_Template, 9, 5)(11, LayoutComponent_Conditional_11_Template, 4, 0);
        \u0275\u0275elementEnd()();
...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./login.component-3RXLAOCW.js").then((m) => m.LoginComponent),
    data: { flow: { node: "login", entry: true, edgesTo: ["items", "signup"] } }
  },
  {
    path: "signup",
    loadComponent: () => import("./signup.component-DLY6NTIU.js").then((m) => m.SignupComponent),
    data: { flow: { node: "signup", edgesTo: ["items", "login"] } }
  },
  {
    path: "",
    component: LayoutComponent,
    children: [
      // ---- Items (any logged-in user) ----
      {
        path: "",
        pathMatch: "full",
        canActivate: [authGuard],
        loadComponent: () => import("./items-list.component-DWT6QICW.js").then((m) => m.ItemsListComponent),
        data: { flow: { node: "items", showInNavbar: true, edgesTo: ["item-detail", "movement-record"] } }
      },
      {
        path: "items/new",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./item-form.component-K2EF5JMK.js").then((m) => m.ItemFormComponent),
        data: { roles: MANAGER.roles, flow: { node: "item-form", scope: "manager", edgesTo: ["items"] } }
      },
      {
        path: "items/:id",
        canActivate: [authGuard],
        loadComponent: () => import("./item-detail.component-NE2GIMZ4.js").then((m) => m.ItemDetailComponent),
        data: { flow: { node: "item-detail", edgesTo: ["items", "item-form", "movement-record"] } }
      },
      {
        path: "items/:id/edit",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./item-form.component-K2EF5JMK.js").then((m) => m.ItemFormComponent),
        data: { roles: MANAGER.roles, flow: { node: "item-form", scope: "manager", edgesTo: ["item-detail", "items"] } }
      },
      // ---- Locations (manager) ----
      {
        path: "locations",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./locations-list.component-622XFDP3.js").then((m) => m.LocationsListComponent),
        data: { roles: MANAGER.roles, flow: { node: "locations", showInNavbar: true, scope: "manager", edgesTo: ["location-form"] } }
      },
      {
        path: "locations/new",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./location-form.component-JOOZTCT5.js").then((m) => m.LocationFormComponent),
        data: { roles: MANAGER.roles, flow: { node: "location-form", scope: "manager", edgesTo: ["locations"] } }
      },
      {
      ...
      // ---- Movements ----
      {
        path: "movements/new",
        canActivate: [authGuard],
        loadComponent: () => import("./movement-record.component-SSOFEXK2.js").then((m) => m.MovementRecordComponent),
        data: { flow: { node: "movement-record", showInNavbar: true, edgesTo: ["items"] } }
      },
      {
        path: "movements",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./movements-log.component-HVTA3TY3.js").then((m) => m.MovementsLogComponent),
        data: { roles: MANAGER.roles, flow: { node: "movements-log", showInNavbar: true, scope: "manager", edgesTo: ["item-detail"] } }
      },
      // ---- Reports (manager) ----
      {
        path: "reports/low-stock",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./low-stock-report.component-KKAMBNMD.js").then((m) => m.LowStockReportComponent),
        data: { roles: MANAGER.roles, flow: { node: "low-stock-report", showInNavbar: true, scope: "manager", edgesTo: ["item-detail", "movement-record"] } }
      },
      // ---- Admin settings (manager) ----
      {
        path: "admin/settings",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./settings.component-6JYSQWLW.js").then((m) => m.SettingsComponent),
        data: { roles: MANAGER.roles, flow: { node: "settings", showInNavbar: true, scope: "manager", edgesTo: ["items"] } }
      }
    ]
  },
  { path: "**", redirectTo: "" }

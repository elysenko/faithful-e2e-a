...
var LoginComponent = class _LoginComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 31, vars: 6, consts: [[1, "auth-wrap"], [1, "auth-card", "card"], ["routerLink", "/catalog", 1, "brand"], [1, "brand-mark"], [1, "brand-name"], [1, "muted"], [3, "ngSubmit", "formGroup"], [1, "field"], ["for", "email"], ["id", "email", "type", "email", "formControlName", "email", "autocomplete", "email", "data-testid", "login-email", "placeholder", "you@example.com", 1, "input"], [1, "alert", "alert-error"], ["for", "password"], ["id", "password", "type", "password", "formControlName", "password", "autocomplete", "current-password", "data-testid", "login-password", "placeholder", "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", 1, "input"], ["type", "submit", "data-testid", "login-submit", 1, "btn", "btn-primary", "btn-block", 3, "disabled"], [1, "switch"], ["routerLink", "/signup"], ["data-testid", "demo-mode", 1, "btn", "btn-block", "demo", 3, "click"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(10, "Welcome back. Sign in to your account.");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275template(16, LoginComponent_Conditional_16_Template, 2, 0, "span", 10);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(17, "div", 7)(18, "label", 11);
        \u0275\u0275text(19, "Password");
        \u0275\u0275elementEnd();
        \u0275\u0275element(20, "input", 12);
        \u0275\u0275template(21, LoginComponent_Conditional_21_Template, 2, 0, "span", 10);
        \u0275\u0275elementEnd();
        \u0275\u0275template(22, LoginComponent_Conditional_22_Template, 2, 1, "div", 10);
...
//# sourceMappingURL=login.component-JWRGSRKN.js.map

...
var LoginComponent = class _LoginComponent {
  constructor(fb, auth, router) {
    ...
    this.form = this.fb.group({
      email: ["coach@demo", [Validators.required, Validators.email]],
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 37, vars: 6, consts: [[1, "auth-wrap"], [1, "auth-card", "card"], [1, "auth-brand"], [1, "auth-mark"], [1, "auth-name"], [1, "muted", "center"], ["novalidate", "", 3, "ngSubmit", "formGroup"], [1, "field"], ["for", "email"], ["id", "email", "type", "email", "formControlName", "email", "autocomplete", "email", "placeholder", "you@club.org", 1, "input"], [1, "field-error"], ["for", "password"], ["id", "password", "type", "password", "formControlName", "password", "autocomplete", "current-password", "placeholder", "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", 1, "input"], [1, "alert", "alert-danger"], ["type", "submit", 1, "btn", "btn-primary", "btn-block", 3, "disabled"], [1, "small", "center", 2, "margin-top", "var(--sp-4)"], ["routerLink", "/signup"], [1, "divider"], [1, "text-xs", "muted", "center", 2, "margin-bottom", "var(--sp-2)"], [1, "role-grid"], [1, "btn", "btn-outline", "btn-sm", 3, "click"], [1, "link-btn", "demo-skip", 3, "click"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(8, "Sign in to your rowing club");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(36, "Skip login \u2014 Demo Mode \u2192");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        let tmp_1_0;
...
//# sourceMappingURL=login.component-CQT423YK.js.map

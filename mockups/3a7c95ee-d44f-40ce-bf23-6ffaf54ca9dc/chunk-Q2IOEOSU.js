...
var AuthService = class _AuthService {
  constructor(http, router) {
    ...
    this.isSales = computed(() => this.hasRole("sales", "admin"));
    this.isPurchasing = computed(() => this.hasRole("purchasing", "admin"));
  }
  hasRole(...roles) {
  ...
  /** Open signup — first user server-side becomes admin, later ones sales. */
...
//# sourceMappingURL=chunk-Q2IOEOSU.js.map

...
var EventsListComponent = class _EventsListComponent {
    ...
    this.allEvents = signal([
      {
        ...
        description: "A cozy evening of live synth-pop from three local acts.",
        category: "Music",
      ...
      },
      {
        ...
        description: "Casual morning meetup for early-stage founders and builders.",
        category: "Networking",
        ...
        confirmedCount: 40,
        waitlistCount: 6,
        venue: { id: "v2", name: "Riverside Hall", address: "5 Canal Street", defaultCapacity: 80 }
      },
      {
        id: "e3",
        venueId: "v1",
        title: "Intro to Watercolor",
        description: "Hands-on beginner workshop \u2014 materials provided.",
        category: "Workshop",
      ...
      },
      {
        ...
        description: "Local produce, bakers, and makers. Free entry.",
        category: "Community",
      ...
      },
      {
        ...
        description: "An intimate night pairing live jazz with regional wines.",
        category: "Music",
  ...
  static {
    this.\u0275fac = function EventsListComponent_Factory(t) {
      return new (t || _EventsListComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventsListComponent, { className: "EventsListComponent", filePath: "src/app/pages/events-list/events-list.component.ts", lineNumber: 20 });
})();
export {
  EventsListComponent
};
//# sourceMappingURL=events-list.component-KHXN2F4O.js.map

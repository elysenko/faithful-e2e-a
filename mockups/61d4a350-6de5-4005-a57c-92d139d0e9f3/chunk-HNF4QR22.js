...
var AuthService = class _AuthService {
  constructor(http, router) {
    ...
    this.isOrganizer = computed(() => this._user()?.role === "organizer");
  }
  hasRole(...roles) {
  ...
  /** Open signup — first user server-side becomes organizer, later ones attendee. */
  ...
  demoLogin(role = "organizer") {
    const user = role === "organizer" ? { id: "demo-organizer", email: "organizer@demo", name: "Demo Organizer", role: "organizer" } : { id: "demo-attendee", email: "attendee1@demo", name: "Demo Attendee", role: "attendee" };
...
//# sourceMappingURL=chunk-HNF4QR22.js.map

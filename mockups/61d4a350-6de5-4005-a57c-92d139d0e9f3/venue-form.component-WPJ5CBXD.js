...
var VenueFormComponent = class _VenueFormComponent {
  constructor(route, router) {
    ...
    this.venues = signal([
      { id: "v1", name: "The Warehouse", address: "12 Dock Road, Riverside", defaultCapacity: 150 },
      { id: "v2", name: "Riverside Hall", address: "5 Canal Street, Old Town", defaultCapacity: 80 },
      { id: "v3", name: "Rooftop 22", address: "22 Skyline Ave", defaultCapacity: 60 }
    ]);
    this.form = {
      name: "",
      address: "",
  ...
  ngOnInit() {
    ...
    if (id) {
      ...
      const existing = this.venues().find((v) => v.id === id);
      if (existing) {
        this.form = {
          name: existing.name,
  ...
  static {
    this.\u0275fac = function VenueFormComponent_Factory(t) {
      return new (t || _VenueFormComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VenueFormComponent, { className: "VenueFormComponent", filePath: "src/app/pages/venue-form/venue-form.component.ts", lineNumber: 19 });
})();
export {
  VenueFormComponent
};
//# sourceMappingURL=venue-form.component-WPJ5CBXD.js.map

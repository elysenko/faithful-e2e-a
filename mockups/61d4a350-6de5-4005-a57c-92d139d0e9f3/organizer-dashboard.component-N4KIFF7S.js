...
var OrganizerDashboardComponent = class _OrganizerDashboardComponent {
  constructor() {
    ...
    this.venues = signal([
      { id: "v1", name: "The Warehouse", address: "12 Dock Road", defaultCapacity: 150 },
      { id: "v2", name: "Riverside Hall", address: "5 Canal Street", defaultCapacity: 80 }
    ]);
  ...
  createEvent() {
    ...
    const created = {
      ...
      endsAt: this.form.endsAt || this.form.startsAt,
  ...
  static {
    this.\u0275fac = function OrganizerDashboardComponent_Factory(t) {
      return new (t || _OrganizerDashboardComponent)();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrganizerDashboardComponent, { className: "OrganizerDashboardComponent", filePath: "src/app/pages/organizer-dashboard/organizer-dashboard.component.ts", lineNumber: 20 });
})();
export {
  OrganizerDashboardComponent
};
//# sourceMappingURL=organizer-dashboard.component-N4KIFF7S.js.map

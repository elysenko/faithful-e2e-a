...
function LayoutComponent_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("organizer", ctx_r2.auth.isOrganizer());
    \u0275\u0275advance(2);
...
var LayoutComponent = class _LayoutComponent {
  constructor(auth) {
    this.auth = auth;
    this.allNav = [
      { label: "Home", icon: "\u{1F3E0}", link: "/", scope: "public", exact: true },
      { label: "Events", icon: "\u{1F39F}\uFE0F", link: "/events", scope: "public" },
      { label: "My Events", icon: "\u2B50", link: "/my-events", scope: "auth" },
      { label: "Organizer", icon: "\u{1F4CB}", link: "/organizer", scope: "organizer", exact: true },
      { label: "Venues", icon: "\u{1F4CD}", link: "/organizer/venues", scope: "organizer" },
      { label: "Settings", icon: "\u2699\uFE0F", link: "/organizer/settings", scope: "organizer" }
    ];
    this.nav = computed(() => {
      const loggedIn = this.auth.isLoggedIn();
      const organizer = this.auth.isOrganizer();
    ...
    this.roleLabel = computed(() => this.auth.isOrganizer() ? "Organizer" : "Attendee");
  }
  ngOnInit() {
...
var ORGANIZER = { roles: ["organizer"] };
var routes = [
  {
    path: "login",
    loadComponent: () => import("./login.component-2UU466HB.js").then((m) => m.LoginComponent),
    data: { flow: { node: "login", entry: true, edgesTo: ["home", "signup", "organizer"] } }
  },
  {
    path: "signup",
    loadComponent: () => import("./signup.component-FNTWLNHN.js").then((m) => m.SignupComponent),
    data: { flow: { node: "signup", edgesTo: ["home", "login"] } }
  },
  {
    path: "",
    ...
    children: [
      // ---- Public browse ----
      {
        path: "",
        pathMatch: "full",
        loadComponent: () => import("./home.component-NDIHTTZH.js").then((m) => m.HomeComponent),
        data: { flow: { node: "home", showInNavbar: true, edgesTo: ["events", "event-detail", "my-events"] } }
      },
      {
        path: "events",
        loadComponent: () => import("./events-list.component-KHXN2F4O.js").then((m) => m.EventsListComponent),
        data: { flow: { node: "events", showInNavbar: true, edgesTo: ["event-detail", "home"] } }
      },
      {
        path: "events/:id",
        loadComponent: () => import("./event-detail.component-H7NSPHY2.js").then((m) => m.EventDetailComponent),
        data: { flow: { node: "event-detail", edgesTo: ["events", "login", "my-events"] } }
      },
      // ---- Attendee (any logged-in user) ----
      {
        path: "my-events",
        canActivate: [authGuard],
        loadComponent: () => import("./my-events.component-2IDWJ222.js").then((m) => m.MyEventsComponent),
        data: { flow: { node: "my-events", showInNavbar: true, scope: "attendee", edgesTo: ["event-detail", "events"] } }
      },
      // ---- Organizer ----
      {
        path: "organizer",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./organizer-dashboard.component-N4KIFF7S.js").then((m) => m.OrganizerDashboardComponent),
        data: { roles: ORGANIZER.roles, flow: { node: "organizer", showInNavbar: true, scope: "organizer", edgesTo: ["organizer-event-attendees", "venues"] } }
      },
      {
        path: "organizer/events/:id",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./organizer-event-attendees.component-UPSU3C3K.js").then((m) => m.OrganizerEventAttendeesComponent),
        data: { roles: ORGANIZER.roles, flow: { node: "organizer-event-attendees", scope: "organizer", edgesTo: ["organizer"] } }
      },
      {
        path: "organizer/venues",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./venues-list.component-6WVJFIY4.js").then((m) => m.VenuesListComponent),
        data: { roles: ORGANIZER.roles, flow: { node: "venues", showInNavbar: true, scope: "organizer", edgesTo: ["venue-form"] } }
      },
      {
        path: "organizer/venues/new",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./venue-form.component-WPJ5CBXD.js").then((m) => m.VenueFormComponent),
        data: { roles: ORGANIZER.roles, flow: { node: "venue-form", scope: "organizer", edgesTo: ["venues"] } }
      },
      {
      ...
      },
      {
        ...
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./admin-settings.component-5JGWLBUQ.js").then((m) => m.AdminSettingsComponent),
        data: { roles: ORGANIZER.roles, flow: { node: "admin-settings", showInNavbar: true, scope: "organizer", edgesTo: ["organizer"] } }
      }
    ]
  },
  { path: "**", redirectTo: "" }

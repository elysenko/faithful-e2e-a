...
var OrganizerEventAttendeesComponent = class _OrganizerEventAttendeesComponent {
    ...
    this.attendees = signal([
      {
        ...
        userId: "u1",
        status: "checkedIn",
        user: { id: "u1", email: "ada@example.com", name: "Ada Lovelace", role: "attendee" }
      },
      {
        id: "r2",
        eventId: "e1",
        userId: "u2",
        status: "confirmed",
        user: { id: "u2", email: "grace@example.com", name: "Grace Hopper", role: "attendee" }
      },
      {
        id: "r3",
        eventId: "e1",
        userId: "u3",
        status: "confirmed",
        user: { id: "u3", email: "linus@example.com", name: "Linus T.", role: "attendee" }
      },
      {
        id: "r4",
        eventId: "e1",
        userId: "u4",
        status: "waitlist",
        user: { id: "u4", email: "edsger@example.com", name: "Edsger D.", role: "attendee" }
      }
    ]);
  ...
  toggleCheckin(r) {
    const next = r.status === "checkedIn" ? "confirmed" : "checkedIn";
    this.attendees.update((list) => list.map((a) => a.id === r.id ? __spreadProps(__spreadValues({}, a), { status: next }) : a));
  }
  badge(status) {
    switch (status) {
      case "confirmed":
  ...
  static {
    this.\u0275fac = function OrganizerEventAttendeesComponent_Factory(t) {
      return new (t || _OrganizerEventAttendeesComponent)(\u0275\u0275directiveInject(ActivatedRoute));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrganizerEventAttendeesComponent, { className: "OrganizerEventAttendeesComponent", filePath: "src/app/pages/organizer-event-attendees/organizer-event-attendees.component.ts", lineNumber: 18 });
})();
export {
  OrganizerEventAttendeesComponent
};
//# sourceMappingURL=organizer-event-attendees.component-UPSU3C3K.js.map

...
var AdminSettingsComponent = class _AdminSettingsComponent {
  constructor() {
    ...
    this.settings = signal([
      { key: "DATABASE_URL", service: "postgresql", label: "Connection URL", value: "postgres://\u2026@db:5432/gatherup", configured: true },
    ...
    this.serviceMeta = {
      ...
      minio: { title: "MinIO Object Storage", blurb: "S3-compatible object storage for future media uploads." }
    };
...
//# sourceMappingURL=admin-settings.component-5JGWLBUQ.js.map

...
var VenuesListComponent = class _VenuesListComponent {
  ...
  static {
    this.\u0275fac = function VenuesListComponent_Factory(t) {
      return new (t || _VenuesListComponent)();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VenuesListComponent, { className: "VenuesListComponent", filePath: "src/app/pages/venues-list/venues-list.component.ts", lineNumber: 17 });
})();
export {
  VenuesListComponent
};
//# sourceMappingURL=venues-list.component-6WVJFIY4.js.map

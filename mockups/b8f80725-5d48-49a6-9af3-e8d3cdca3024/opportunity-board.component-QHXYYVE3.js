...
// src/app/features/opportunities/opportunity-board.component.ts
var _forTrack0 = ($index, $item) => $item.key;
var _forTrack1 = ($index, $item) => $item.id;
function OpportunityBoardComponent_For_12_For_13_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 22);
  }
}
function OpportunityBoardComponent_For_12_For_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "article", 14);
    \u0275\u0275listener("click", function OpportunityBoardComponent_For_12_For_13_Template_article_click_0_listener() {
      const o_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openCard(o_r5.id));
    });
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, OpportunityBoardComponent_For_12_For_13_div_13_Template, 1, 0, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(10, 4, o_r5.amount, "USD", "symbol", "1.0-0"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", o_r5.probability, "%");
  }
}
function OpportunityBoardComponent_For_12_ForEmpty_14_Template(rf, ctx) {
  if (rf & 1) {
...
function OpportunityBoardComponent_For_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("cdkDropListDropped", function OpportunityBoardComponent_For_12_Template_div_cdkDropListDropped_11_listener($event) {
      const s_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.drop($event, s_r2.key));
    });
    \u0275\u0275repeaterCreate(12, OpportunityBoardComponent_For_12_For_13_Template, 14, 9, "article", 12, _forTrack1, false, OpportunityBoardComponent_For_12_ForEmpty_14_Template, 2, 0, "div", 13);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275styleProp("--stage", s_r2.color);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(s_r2.label);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.cards(s_r2.key).length);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(10, 8, ctx_r2.columnTotal(s_r2.key), "USD", "symbol", "1.0-0"));
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "col-" + s_r2.key)("cdkDropListData", ctx_r2.cards(s_r2.key));
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.cards(s_r2.key));
  }
}
var OpportunityBoardComponent = class _OpportunityBoardComponent {
  constructor() {
    this.router = inject(Router);
    this.stageMeta = STAGE_META;
    this.stageIds = STAGE_META.map((s) => "col-" + s.key);
    ...
    this.columns = signal(this.groupByStage(this.opportunities()));
    this.boardTotal = computed(() => Object.values(this.columns()).flat().reduce((sum, o) => sum + o.amount, 0));
  }
  groupByStage(items) {
    const map2 = {};
    ...
    for (const o of items)
      (map2[o.stage] ??= []).push(__spreadValues({}, o));
    return map2;
  }
  cards(stage) {
  ...
  columnTotal(stage) {
    return this.cards(stage).reduce((sum, o) => sum + o.amount, 0);
  }
  drop(event, targetStage) {
    ...
    this.columns.update((c) => __spreadValues({}, c));
  }
  openCard(id) {
    this.router.navigate(["/opportunities", id]);
  }
  static {
    this.\u0275fac = function OpportunityBoardComponent_Factory(t) {
      return new (t || _OpportunityBoardComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OpportunityBoardComponent, selectors: [["app-opportunity-board"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 6, consts: [[1, "board-page"], [1, "page-head"], [1, "muted"], ["routerLink", "/opportunities/new", 1, "btn", "btn-primary"], ["cdkDropListGroup", "", 1, "board"], [1, "column"], [1, "col-head"], [1, "col-title"], [1, "col-swatch"], [1, "col-count"], [1, "col-sum", "mono"], ["cdkDropList", "", 1, "col-list", 3, "cdkDropListDropped", "id", "cdkDropListData"], ["cdkDrag", "", 1, "deal"], [1, "col-empty", "muted"], ["cdkDrag", "", 1, "deal", 3, "click"], ["cdkDragHandle", "", "aria-label", "Drag deal", 1, "deal-drag"], [1, "deal-name"], [1, "deal-account", "muted"], [1, "deal-foot"], [1, "deal-amount", "mono"], [1, "badge"], ["class", "deal-placeholder", 4, "cdkDragPlaceholder"], [1, "deal-placeholder"]], template: function OpportunityBoardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "div")(3, "h1");
        \u0275\u0275text(4, "Pipeline Board");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(9, "+ New Opportunity");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(10, "div", 4);
        \u0275\u0275repeaterCreate(11, OpportunityBoardComponent_For_12_Template, 15, 13, "section", 5, _forTrack0);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate1("Drag deals between stages \xB7 ", \u0275\u0275pipeBind4(7, 1, ctx.boardTotal(), "USD", "symbol", "1.0-0"), " total pipeline");
        \u0275\u0275advance(5);
        \u0275\u0275repeater(ctx.stageMeta);
      }
    }, dependencies: [CommonModule, CurrencyPipe, RouterLink, DragDropModule, CdkDropList, CdkDropListGroup, CdkDrag, CdkDragHandle, CdkDragPlaceholder], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n.board-page[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: var(--space-5);\n  max-width: 100%;\n}\n.board[_ngcontent-%COMP%] {\n  display: flex;\n  gap: var(--space-4);\n  overflow-x: auto;\n  padding-bottom: var(--space-4);\n  -webkit-overflow-scrolling: touch;\n  overscroll-behavior-x: contain;\n}\n.column[_ngcontent-%COMP%] {\n  flex: 0 0 272px;\n  width: 272px;\n  background: var(--color-surface-alt);\n  border: 1px solid var(--color-border);\n  border-radius: var(--radius-lg);\n  padding: var(--space-3);\n  display: flex;\n  flex-direction: column;\n}\n.col-head[_ngcontent-%COMP%] {\n  --stage: var(--color-brand);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.col-title[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: var(--space-2);\n  font-weight: 700;\n  font-size: var(--text-sm);\n}\n.col-swatch[_ngcontent-%COMP%] {\n  width: 10px;\n  height: 10px;\n  border-radius: 3px;\n  background: var(--stage);\n}\n.col-count[_ngcontent-%COMP%] {\n  background: var(--color-surface);\n  border: 1px solid var(--color-border);\n  border-radius: var(--radius-pill);\n  padding: 0 8px;\n  font-size: var(--text-xs);\n  font-weight: 700;\n}\n.col-sum[_ngcontent-%COMP%] {\n  font-size: var(--text-xs);\n  color: var(--color-text-muted);\n  margin: 2px 0 var(--space-3) 18px;\n}\n.col-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: var(--space-2);\n  min-height: 80px;\n  flex: 1;\n}\n.col-empty[_ngcontent-%COMP%] {\n  text-align: center;\n  padding: var(--space-5) var(--space-2);\n  border: 1px dashed var(--color-border-strong);\n  border-radius: var(--radius-md);\n  font-size: var(--text-sm);\n}\n.deal[_ngcontent-%COMP%] {\n  position: relative;\n  background: var(--color-surface);\n  border: 1px solid var(--color-border);\n  border-radius: var(--radius-md);\n  box-shadow: var(--shadow-sm);\n  padding: var(--space-3);\n  cursor: pointer;\n  transition: box-shadow 0.12s ease, transform 0.06s ease;\n}\n.deal[_ngcontent-%COMP%]:hover {\n  box-shadow: var(--shadow-md);\n}\n.deal[_ngcontent-%COMP%]:active {\n  transform: scale(0.99);\n}\n.deal-drag[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 6px;\n  right: 8px;\n  color: var(--color-text-muted);\n  cursor: grab;\n  letter-spacing: -2px;\n  padding: 2px;\n}\n.deal-name[_ngcontent-%COMP%] {\n  font-size: var(--text-sm);\n  font-weight: 600;\n  margin: 0 var(--space-4) 2px 0;\n}\n.deal-account[_ngcontent-%COMP%] {\n  font-size: var(--text-xs);\n  margin: 0 0 var(--space-3);\n}\n.deal-foot[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.deal-amount[_ngcontent-%COMP%] {\n  font-weight: 700;\n  font-size: var(--text-sm);\n}\n.cdk-drag-preview[_ngcontent-%COMP%] {\n  box-shadow: var(--shadow-lg);\n  border-radius: var(--radius-md);\n}\n.cdk-drag-animating[_ngcontent-%COMP%] {\n  transition: transform 0.2s cubic-bezier(0, 0, 0.2, 1);\n}\n.deal-placeholder[_ngcontent-%COMP%] {\n  background: var(--color-brand-light);\n  border: 1px dashed var(--color-brand);\n  border-radius: var(--radius-md);\n  min-height: 64px;\n}\n.col-list.cdk-drop-list-dragging[_ngcontent-%COMP%]   .deal[_ngcontent-%COMP%]:not(.cdk-drag-placeholder) {\n  transition: transform 0.2s cubic-bezier(0, 0, 0.2, 1);\n}\n/*# sourceMappingURL=board.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OpportunityBoardComponent, { className: "OpportunityBoardComponent", filePath: "src/app/features/opportunities/opportunity-board.component.ts", lineNumber: 19 });
})();
export {
  OpportunityBoardComponent
};
//# sourceMappingURL=opportunity-board.component-QHXYYVE3.js.map

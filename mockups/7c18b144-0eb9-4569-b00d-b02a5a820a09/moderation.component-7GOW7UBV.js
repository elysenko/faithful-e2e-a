...
var ModerationComponent = class _ModerationComponent {
  constructor() {
    ...
    this.users = signal([
      { id: "u1", name: "Maya Chen", jobTitle: "Senior Product Designer", employer: "Figma", role: "user", banned: false, reports: 0, joinedAt: "Mar 2026" },
      { id: "u5", name: "Chris Blunt", jobTitle: "Growth Hacker", employer: "Unknown", role: "user", banned: false, reports: 3, joinedAt: "Jun 2026" },
      { id: "u6", name: "Dana Fields", jobTitle: "Recruiter", employer: "TalentCo", role: "user", banned: false, reports: 1, joinedAt: "May 2026" },
      { id: "u2", name: "Daniel Okoye", jobTitle: "Engineering Manager", employer: "Stripe", role: "user", banned: false, reports: 0, joinedAt: "Feb 2026" },
      { id: "u7", name: "Sam Ghost", jobTitle: "\u2014", employer: "\u2014", role: "user", banned: true, reports: 5, joinedAt: "Apr 2026" }
    ]);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModerationComponent, { className: "ModerationComponent", filePath: "src/app/features/admin/moderation.component.ts", lineNumber: 14 });
})();
export {
  ModerationComponent
};
//# sourceMappingURL=moderation.component-7GOW7UBV.js.map

...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./login.component-N7R3LS4Y.js").then((m) => m.LoginComponent),
    data: { flow: { flowId: "login", node: "login", entry: true, edgesTo: ["dashboard", "signup"], label: "Login" } }
  },
  {
    path: "signup",
    loadComponent: () => import("./signup.component-FU6JTTIV.js").then((m) => m.SignupComponent),
    data: { flow: { flowId: "signup", node: "signup", edgesTo: ["dashboard", "login"], label: "Sign up" } }
  },
  {
    path: "",
    loadComponent: () => import("./shell.component-2TTTHB62.js").then((m) => m.ShellComponent),
    canActivate: [authGuard],
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        loadComponent: () => import("./dashboard.component-KMNUAPRR.js").then((m) => m.DashboardComponent),
        data: { flow: { flowId: "dashboard", node: "dashboard", showInNavbar: true, label: "Dashboard", scope: "all", edgesTo: ["accounts", "contacts", "pipeline", "leads", "tasks"] } }
      },
      {
        path: "accounts",
        loadComponent: () => import("./accounts-list.component-GSWIS25I.js").then((m) => m.AccountsListComponent),
        data: { flow: { flowId: "accounts", node: "accounts", showInNavbar: true, label: "Accounts", scope: "all", edgesTo: ["account-detail"] } }
      },
      {
        path: "accounts/:id",
        loadComponent: () => import("./account-detail.component-ZM52GJZI.js").then((m) => m.AccountDetailComponent),
        data: { flow: { flowId: "account-detail", node: "account-detail", label: "Account detail", scope: "all", edgesTo: ["accounts", "contacts", "pipeline"] } }
      },
      {
        path: "contacts",
        loadComponent: () => import("./contacts-list.component-YVDECRTH.js").then((m) => m.ContactsListComponent),
        data: { flow: { flowId: "contacts", node: "contacts", showInNavbar: true, label: "Contacts", scope: "all" } }
      },
      {
        path: "pipeline",
        loadComponent: () => import("./pipeline-board.component-BKIFRBKX.js").then((m) => m.PipelineBoardComponent),
        data: { flow: { flowId: "pipeline", node: "pipeline", showInNavbar: true, label: "Pipeline", scope: "all" } }
      },
      {
        path: "leads",
        loadComponent: () => import("./leads-list.component-JBEESPKD.js").then((m) => m.LeadsListComponent),
        data: { flow: { flowId: "leads", node: "leads", showInNavbar: true, label: "Leads", scope: "all" } }
      },
      {
        path: "tasks",
        loadComponent: () => import("./tasks-list.component-67C5T5NG.js").then((m) => m.TasksListComponent),
        data: { flow: { flowId: "tasks", node: "tasks", showInNavbar: true, label: "Tasks", scope: "all" } }
      }
    ]
  },

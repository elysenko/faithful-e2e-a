...
// src/app/features/opportunities/pipeline-board.component.ts
var _forTrack0 = ($index, $item) => $item.key;
var _forTrack1 = ($index, $item) => $item.id;
function PipelineBoardComponent_For_11_For_12_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const opp_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(2, 1, opp_r4.closeDate, "MMM d"));
  }
}
function PipelineBoardComponent_For_11_For_12_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 23);
  }
}
function PipelineBoardComponent_For_11_For_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article", 14)(1, "div", 16);
    \u0275\u0275text(2, "\u22EE\u22EE");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(10, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, PipelineBoardComponent_For_11_For_12_Conditional_11_Template, 3, 4, "span", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, PipelineBoardComponent_For_11_For_12_div_12_Template, 1, 0, "div", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const opp_r4 = ctx.$implicit;
    \u0275\u0275property("cdkDragData", opp_r4);
    \u0275\u0275attribute("data-testid", "opp-" + opp_r4.id);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(opp_r4.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(opp_r4.accountName);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(10, 6, opp_r4.amount, "USD", "symbol", "1.0-0"));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(11, opp_r4.closeDate ? 11 : -1);
  }
}
function PipelineBoardComponent_For_11_ForEmpty_13_Template(rf, ctx) {
  if (rf & 1) {
...
function PipelineBoardComponent_For_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 6)(1, "header", 8)(2, "div", 9);
    \u0275\u0275element(3, "span", 10);
    \u0275\u0275text(4);
    ...
    \u0275\u0275listener("cdkDropListDropped", function PipelineBoardComponent_For_11_Template_div_cdkDropListDropped_10_listener($event) {
      const stage_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.drop($event, stage_r2.key));
    });
    \u0275\u0275repeaterCreate(11, PipelineBoardComponent_For_11_For_12_Template, 13, 11, "article", 14, _forTrack1, false, PipelineBoardComponent_For_11_ForEmpty_13_Template, 2, 0, "div", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const stage_r2 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275attribute("data-testid", "column-" + stage_r2.key);
    \u0275\u0275advance();
    \u0275\u0275styleProp("border-top-color", stage_r2.accent);
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("background", stage_r2.accent);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", stage_r2.label, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.columnFor(stage_r2.key).length);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(9, 12, ctx_r2.totalFor(stage_r2.key), "USD", "symbol", "1.0-0"));
    \u0275\u0275advance(2);
    \u0275\u0275property("id", stage_r2.key)("cdkDropListData", ctx_r2.columnFor(stage_r2.key))("cdkDropListConnectedTo", ctx_r2.stageIds);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.columnFor(stage_r2.key));
  }
}
function PipelineBoardComponent_Conditional_12_For_23_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(a_r6.name);
  }
}
function PipelineBoardComponent_Conditional_12_For_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", s_r7.key);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(s_r7.label);
  }
}
function PipelineBoardComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275listener("click", function PipelineBoardComponent_Conditional_12_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeCreate());
    });
    \u0275\u0275elementStart(1, "div", 25);
    \u0275\u0275listener("click", function PipelineBoardComponent_Conditional_12_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 26)(3, "h2", 27);
    \u0275\u0275text(4, "New opportunity");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 28);
    \u0275\u0275listener("click", function PipelineBoardComponent_Conditional_12_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeCreate());
    });
    \u0275\u0275text(6, "\u2715");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "form", 29);
    \u0275\u0275listener("ngSubmit", function PipelineBoardComponent_Conditional_12_Template_form_ngSubmit_7_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 30)(13, "label", 33);
    \u0275\u0275text(14, "Amount (USD)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "input", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 30)(17, "label", 35);
    \u0275\u0275text(18, "Account");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "select", 36)(20, "option", 37);
    \u0275\u0275text(21, "Select account\u2026");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(22, PipelineBoardComponent_Conditional_12_For_23_Template, 2, 2, "option", 38, _forTrack1);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 30)(25, "label", 39);
    \u0275\u0275text(26, "Stage");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "select", 40);
    \u0275\u0275repeaterCreate(28, PipelineBoardComponent_Conditional_12_For_29_Template, 2, 2, "option", 38, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 30)(31, "label", 41);
    \u0275\u0275text(32, "Close date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(33, "input", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 43)(35, "button", 44);
    \u0275\u0275listener("click", function PipelineBoardComponent_Conditional_12_Template_button_click_35_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeCreate());
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(15);
    \u0275\u0275repeater(ctx_r2.accountOptions());
    \u0275\u0275advance(6);
...
var PipelineBoardComponent = class _PipelineBoardComponent {
  constructor() {
    this.route = inject(ActivatedRoute);
    this.router = inject(Router);
    this.fb = inject(FormBuilder);
    this.stages = OPPORTUNITY_STAGES;
    this.stageIds = OPPORTUNITY_STAGES.map((s) => s.key);
    this.opportunities = signal([
      { id: "o1", name: "Globex \u2014 Platform license", amount: 48e3, stage: "Proposal", accountId: "1", accountName: "Globex Corporation", closeDate: "2026-08-01" },
      { id: "o2", name: "Globex \u2014 Support renewal", amount: 12e3, stage: "Negotiation", accountId: "1", accountName: "Globex Corporation", closeDate: "2026-07-28" },
      { id: "o3", name: "Initech \u2014 Migration", amount: 3e4, stage: "Qualification", accountId: "2", accountName: "Initech" },
      { id: "o4", name: "Initech \u2014 Add-on seats", amount: 8e3, stage: "Prospecting", accountId: "2", accountName: "Initech" },
      { id: "o5", name: "Umbrella \u2014 Compliance suite", amount: 64e3, stage: "Proposal", accountId: "3", accountName: "Umbrella Co", closeDate: "2026-09-10" },
      { id: "o6", name: "Umbrella \u2014 Pilot program", amount: 15e3, stage: "Prospecting", accountId: "3", accountName: "Umbrella Co" },
      { id: "o7", name: "Soylent \u2014 Annual contract", amount: 52e3, stage: "ClosedWon", accountId: "4", accountName: "Soylent Industries", closeDate: "2026-06-30" },
      { id: "o8", name: "Soylent \u2014 Expansion", amount: 21e3, stage: "Negotiation", accountId: "4", accountName: "Soylent Industries" },
      { id: "o9", name: "Globex \u2014 Legacy upsell", amount: 9e3, stage: "ClosedLost", accountId: "1", accountName: "Globex Corporation" },
      { id: "o10", name: "Initech \u2014 Training package", amount: 6e3, stage: "Qualification", accountId: "2", accountName: "Initech" }
    ]);
  ...
  totalFor(stage) {
    return this.columnFor(stage).reduce((sum, o) => sum + Number(o.amount), 0);
  }
  drop(event, targetStage) {
    if (event.previousContainer === event.container)
      return;
    const opp = event.item.data;
    this.moveStage(opp.id, targetStage);
  }
  moveStage(id, stage) {
  ...
  closeCreate() {
    this.form.reset({ stage: "Prospecting", amount: 0 });
  ...
  submit() {
    ...
    const opp = {
      id: "tmp-" + this.opportunities().length,
      name: v.name,
      amount: Number(v.amount) || 0,
      stage: v.stage,
      accountId: v.accountId,
      accountName,
      closeDate: v.closeDate || void 0
    };
  ...
  static {
    this.\u0275fac = function PipelineBoardComponent_Factory(t) {
      return new (t || _PipelineBoardComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PipelineBoardComponent, selectors: [["app-pipeline-board"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 1, consts: [[1, "page", "pipeline-page"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], ["data-testid", "pipeline-new", 1, "btn", "btn-primary", 3, "click"], [1, "board"], [1, "column"], [1, "overlay"], [1, "col-head"], [1, "col-title"], [1, "col-dot"], [1, "col-count"], [1, "col-total"], ["cdkDropList", "", 1, "col-body", 3, "cdkDropListDropped", "id", "cdkDropListData", "cdkDropListConnectedTo"], ["cdkDrag", "", 1, "opp", "card", 3, "cdkDragData"], [1, "col-empty", "muted", "small"], ["cdkDragHandle", "", 1, "opp-drag-handle"], [1, "opp-name"], [1, "opp-account", "muted", "small"], [1, "opp-foot"], [1, "opp-amount"], [1, "muted", "small"], ["class", "opp-placeholder", 4, "cdkDragPlaceholder"], [1, "opp-placeholder"], [1, "overlay", 3, "click"], ["data-testid", "opp-create-modal", 1, "modal", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "btn-link", 3, "click"], [3, "ngSubmit", "formGroup"], [1, "field"], ["for", "o-name"], ["id", "o-name", "formControlName", "name", "data-testid", "opp-name", "placeholder", "Acme \u2014 New deal", 1, "input"], ["for", "o-amount"], ["id", "o-amount", "type", "number", "formControlName", "amount", "placeholder", "0", 1, "input"], ["for", "o-account"], ["id", "o-account", "formControlName", "accountId", 1, "select"], ["value", ""], [3, "value"], ["for", "o-stage"], ["id", "o-stage", "formControlName", "stage", 1, "select"], ["for", "o-close"], ["id", "o-close", "type", "date", "formControlName", "closeDate", 1, "input"], [1, "modal-actions"], ["type", "button", 1, "btn", "btn-ghost", 3, "click"], ["type", "submit", "data-testid", "opp-save", 1, "btn", "btn-primary", 3, "disabled"]], template: function PipelineBoardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
        \u0275\u0275text(4, "Pipeline");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "p", 3);
        \u0275\u0275text(6, "Drag opportunities between stages");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(7, "button", 4);
        \u0275\u0275listener("click", function PipelineBoardComponent_Template_button_click_7_listener() {
          return ctx.openCreate();
        });
        \u0275\u0275text(8, "+ New opportunity");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(9, "div", 5);
        \u0275\u0275repeaterCreate(10, PipelineBoardComponent_For_11_Template, 14, 17, "section", 6, _forTrack0);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(12, PipelineBoardComponent_Conditional_12_Template, 39, 2, "div", 7);
      }
      if (rf & 2) {
        \u0275\u0275advance(10);
        \u0275\u0275repeater(ctx.stages);
        \u0275\u0275advance(2);
        \u0275\u0275conditional(12, ctx.showCreate() ? 12 : -1);
      }
    }, dependencies: [CommonModule, CurrencyPipe, DatePipe, ReactiveFormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, DragDropModule, CdkDropList, CdkDrag, CdkDragHandle, CdkDragPlaceholder], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n.pipeline-page[_ngcontent-%COMP%] {\n  max-width: none;\n}\n.board[_ngcontent-%COMP%] {\n  display: flex;\n  gap: var(--space-4);\n  overflow-x: auto;\n  overscroll-behavior-x: contain;\n  padding-bottom: var(--space-4);\n  -webkit-overflow-scrolling: touch;\n}\n.column[_ngcontent-%COMP%] {\n  flex: 0 0 280px;\n  display: flex;\n  flex-direction: column;\n  background: var(--color-surface-2);\n  border-radius: var(--radius-md);\n  min-height: 200px;\n}\n.col-head[_ngcontent-%COMP%] {\n  padding: var(--space-3);\n  border-top: 3px solid var(--color-border);\n  border-radius: var(--radius-md) var(--radius-md) 0 0;\n}\n.col-title[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: var(--space-2);\n  font-weight: 700;\n  font-size: var(--text-sm);\n}\n.col-dot[_ngcontent-%COMP%] {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n}\n.col-count[_ngcontent-%COMP%] {\n  margin-left: auto;\n  background: var(--color-surface);\n  color: var(--color-text-muted);\n  border-radius: var(--radius-pill);\n  padding: 1px 8px;\n  font-size: var(--text-xs);\n}\n.col-total[_ngcontent-%COMP%] {\n  margin-top: 2px;\n  font-size: var(--text-xs);\n  color: var(--color-text-muted);\n}\n.col-body[_ngcontent-%COMP%] {\n  flex: 1;\n  padding: var(--space-2);\n  display: flex;\n  flex-direction: column;\n  gap: var(--space-2);\n  min-height: 80px;\n}\n.opp[_ngcontent-%COMP%] {\n  position: relative;\n  padding: var(--space-3);\n  cursor: grab;\n  border-radius: var(--radius-md);\n}\n.opp[_ngcontent-%COMP%]:active {\n  cursor: grabbing;\n}\n.opp-drag-handle[_ngcontent-%COMP%] {\n  position: absolute;\n  top: var(--space-2);\n  right: var(--space-2);\n  color: var(--color-text-faint);\n  font-size: var(--text-xs);\n  cursor: grab;\n  letter-spacing: -2px;\n}\n.opp-name[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: var(--text-sm);\n  padding-right: 18px;\n}\n.opp-account[_ngcontent-%COMP%] {\n  margin-top: 2px;\n}\n.opp-foot[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: var(--space-2);\n}\n.opp-amount[_ngcontent-%COMP%] {\n  font-weight: 700;\n  color: var(--color-success);\n  font-size: var(--text-sm);\n}\n.col-empty[_ngcontent-%COMP%] {\n  border: 1px dashed var(--color-border-strong);\n  border-radius: var(--radius-sm);\n  padding: var(--space-4);\n  text-align: center;\n}\n.cdk-drag-preview[_ngcontent-%COMP%] {\n  box-shadow: var(--shadow-lg);\n  border-radius: var(--radius-md);\n}\n.cdk-drag-animating[_ngcontent-%COMP%] {\n  transition: transform 200ms cubic-bezier(0, 0, 0.2, 1);\n}\n.opp-placeholder[_ngcontent-%COMP%] {\n  background: var(--color-primary-soft);\n  border: 1px dashed var(--color-primary);\n  border-radius: var(--radius-md);\n  min-height: 60px;\n}\n.cdk-drop-list-dragging[_ngcontent-%COMP%]   .opp[_ngcontent-%COMP%]:not(.cdk-drag-placeholder) {\n  transition: transform 200ms cubic-bezier(0, 0, 0.2, 1);\n}\n/*# sourceMappingURL=pipeline-board.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PipelineBoardComponent, { className: "PipelineBoardComponent", filePath: "src/app/features/opportunities/pipeline-board.component.ts", lineNumber: 17 });
})();
export {
  PipelineBoardComponent
};
//# sourceMappingURL=pipeline-board.component-BKIFRBKX.js.map

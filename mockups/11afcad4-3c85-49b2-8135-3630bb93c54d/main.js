...
function LayoutComponent_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("instructor", ctx_r2.auth.isInstructor());
    \u0275\u0275advance(2);
...
var LayoutComponent = class _LayoutComponent {
  constructor(auth) {
    this.auth = auth;
    this.allNav = [
      { label: "Catalog", icon: "\u{1F4DA}", link: "/", scope: "public", exact: true },
      { label: "My Courses", icon: "\u{1F393}", link: "/my-courses", scope: "auth" },
      { label: "Instructor", icon: "\u{1F9D1}\u200D\u{1F3EB}", link: "/instructor", scope: "instructor", exact: true },
      { label: "Settings", icon: "\u2699\uFE0F", link: "/admin/settings", scope: "instructor" }
    ];
    this.nav = computed(() => {
      const loggedIn = this.auth.isLoggedIn();
      const instructor = this.auth.isInstructor();
...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./login.component-6MYFY25P.js").then((m) => m.LoginComponent),
    data: { flow: { node: "login", entry: true, edgesTo: ["catalog", "signup", "instructor"] } }
  },
  {
    path: "signup",
    loadComponent: () => import("./signup.component-I7CNWXQ2.js").then((m) => m.SignupComponent),
  ...
  },
  {
    ...
    children: [
      // ---- Public browse ----
      {
        path: "",
        pathMatch: "full",
        loadComponent: () => import("./catalog.component-MIWX7RYM.js").then((m) => m.CatalogComponent),
        data: { flow: { node: "catalog", showInNavbar: true, edgesTo: ["course-detail", "my-courses"] } }
      },
      {
        path: "courses/:id",
        loadComponent: () => import("./course-detail.component-UWANDTAB.js").then((m) => m.CourseDetailComponent),
        data: { flow: { node: "course-detail", edgesTo: ["catalog", "lesson-viewer", "quiz-take", "login"] } }
      },
      // ---- Learner (any logged-in user) ----
      {
        path: "courses/:id/lessons/:lessonId",
        canActivate: [authGuard],
        loadComponent: () => import("./lesson-viewer.component-GA2BMCFR.js").then((m) => m.LessonViewerComponent),
        data: { flow: { node: "lesson-viewer", scope: "student", edgesTo: ["course-detail", "quiz-take"] } }
      },
      {
        path: "quizzes/:id",
        canActivate: [authGuard],
        loadComponent: () => import("./quiz-take.component-BG23YJLV.js").then((m) => m.QuizTakeComponent),
        data: { flow: { node: "quiz-take", scope: "student", edgesTo: ["course-detail"] } }
      },
      {
        path: "my-courses",
        canActivate: [authGuard],
        loadComponent: () => import("./my-courses.component-TA7ZN4GH.js").then((m) => m.MyCoursesComponent),
        data: { flow: { node: "my-courses", showInNavbar: true, scope: "student", edgesTo: ["course-detail", "catalog"] } }
      },
      // ---- Instructor ----
      {
        path: "instructor",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./instructor-dashboard.component-AZOTTPDW.js").then((m) => m.InstructorDashboardComponent),
        data: { roles: INSTRUCTOR.roles, flow: { node: "instructor", showInNavbar: true, scope: "instructor", edgesTo: ["instructor-course-editor", "gradebook"] } }
      },
      {
        path: "instructor/courses/:id",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./instructor-course-editor.component-6LY5FYN6.js").then((m) => m.InstructorCourseEditorComponent),
        data: { roles: INSTRUCTOR.roles, flow: { node: "instructor-course-editor", scope: "instructor", edgesTo: ["instructor", "gradebook"] } }
      },
      {
        path: "instructor/courses/:id/gradebook",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./gradebook.component-WF4KEHBH.js").then((m) => m.GradebookComponent),
        data: { roles: INSTRUCTOR.roles, flow: { node: "gradebook", scope: "instructor", edgesTo: ["instructor-course-editor", "instructor"] } }
      },
      {
        path: "admin/settings",
        canActivate: [authGuard, roleGuard],
        loadComponent: () => import("./admin-settings.component-HR7I3I4H.js").then((m) => m.AdminSettingsComponent),
        data: { roles: INSTRUCTOR.roles, flow: { node: "admin-settings", showInNavbar: true, scope: "instructor", edgesTo: ["instructor"] } }
      }
    ]
  },
  { path: "**", redirectTo: "" }

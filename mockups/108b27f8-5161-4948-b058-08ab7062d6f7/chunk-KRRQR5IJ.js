...
var AuthService = class _AuthService {
  ...
  /** Open signup — first user server-side becomes admin, later ones shopper. */
  ...
  demoLogin(role = "admin") {
    const user = role === "admin" ? { id: "demo-admin", email: "admin@demo", name: "Demo Admin", role: "admin" } : { id: "demo-shopper", email: "shopper@demo", name: "Demo Shopper", role: "shopper" };
...
//# sourceMappingURL=chunk-KRRQR5IJ.js.map

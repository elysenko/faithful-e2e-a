...
var SignupComponent = class _SignupComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignupComponent, selectors: [["app-signup"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 45, vars: 7, consts: [[1, "auth-shell"], [1, "auth-card", "card"], [1, "auth-brand"], [1, "brand-mark"], [1, "brand-name"], [1, "muted"], [3, "ngSubmit"], [1, "field"], ["for", "name"], ["id", "name", "type", "text", "name", "name", "autocomplete", "name", "placeholder", "Ada Lovelace", 3, "ngModelChange", "ngModel"], ["for", "email"], ["id", "email", "type", "email", "name", "email", "autocomplete", "email", "placeholder", "you@example.com", 3, "ngModelChange", "ngModel"], ["for", "password"], ["id", "password", "type", "password", "name", "password", "autocomplete", "new-password", "placeholder", "At least 8 characters", 3, "ngModelChange", "ngModel"], ["for", "confirm"], ["id", "confirm", "type", "password", "name", "confirm", "autocomplete", "new-password", "placeholder", "Re-enter password", 3, "ngModelChange", "ngModel"], [1, "error"], ["type", "submit", 1, "btn", "btn-primary", "btn-block", 3, "disabled"], [1, "auth-alt"], ["routerLink", "/login"], [1, "demo-hint", "muted"]], template: function SignupComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(10, "Join to start shopping. The first account becomes the admin.");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(36, " Try the demo \u2014 sign in with ");
        \u0275\u0275elementStart(37, "strong");
        \u0275\u0275text(38, "admin@demo");
        \u0275\u0275elementEnd();
        \u0275\u0275text(39, " or ");
        \u0275\u0275elementStart(40, "strong");
        \u0275\u0275text(41, "shopper@demo");
        \u0275\u0275elementEnd();
        \u0275\u0275text(42, " / ");
...
//# sourceMappingURL=signup.component-4KSOX5LG.js.map
